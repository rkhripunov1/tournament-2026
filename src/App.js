...
const TournamentApp = () => {
  ...
  const matches = [
    ...
    { team1: 'Thailand 🇹🇭', team2: 'Ecuador 🇪🇨', time: '9:00 AM', court: 'Court 1' },
    { team1: 'Brazil 🇧🇷', team2: 'Angola 🇦🇴', time: '9:00 AM', court: 'Court 2' },
    { team1: 'El Salvador 🇸🇻', team2: 'Kazakhstan 🇰🇿', time: '9:00 AM', court: 'Court 3' },
    { team1: 'Mexico 🇲🇽', team2: 'Cabo Verde 🇨🇻', time: '1:00 PM', court: 'Court 1' },
    { team1: 'Brazil 🇧🇷', team2: 'Kazakhstan 🇰🇿', time: '1:00 PM', court: 'Court 2' },
    { team1: 'Ecuador 🇪🇨', team2: 'Colombia 🇨🇴', time: '1:00 PM', court: 'Court 3' },
    { team1: 'Argentina 🇦🇷', team2: 'Thailand 🇹🇭', time: '2:00 PM', court: 'Court 1' },
    { team1: 'El Salvador 🇸🇻', team2: 'Angola 🇦🇴', time: '2:00 PM', court: 'Court 2' },
    { team1: 'Iraq 🇮🇶', team2: 'USA 🇺🇸', time: '2:00 PM', court: 'Court 3' },
    { team1: 'Cuba 🇨🇺', team2: 'TBD ❓', time: '3:00 PM', court: 'Court 1' },
    { team1: 'Argentina 🇦🇷', team2: 'Ecuador 🇪🇨', time: '3:00 PM', court: 'Court 2' },
    { team1: 'Portugal 🇵🇹', team2: 'Cabo Verde 🇨🇻', time: '3:00 PM', court: 'Court 3' },
    { team1: 'Argentina 🇦🇷', team2: 'Ecuador 🇪🇨', time: '4:00 PM', court: 'Court 1' },
    { team1: 'Thailand 🇹🇭', team2: 'Colombia 🇨🇴', time: '4:00 PM', court: 'Court 2' },
    { team1: 'Brazil 🇧🇷', team2: 'El Salvador 🇸🇻', time: '4:00 PM', court: 'Court 3' },
    { team1: 'Kazakhstan 🇰🇿', team2: 'Angola 🇦🇴', time: '5:00 PM', court: 'Court 1' },
    { team1: 'Iraq 🇮🇶', team2: 'Cuba 🇨🇺', time: '5:00 PM', court: 'Court 2' },
    { team1: 'Uzbekistan 🇺🇿', team2: 'USA 🇺🇸', time: '5:00 PM', court: 'Court 3' },
  ];
                ...
                <div style={{ borderRadius: '0.5rem', overflow: 'hidden', border: '2px solid #BFFF00' }}>
                  ...
                  {teams.map((team, idx) => (
                    <div key={idx} style={{ display: 'grid', gridTemplateColumns: '2fr 0.5fr 0.5fr 0.5fr 1fr 0.5fr', gap: '0.5rem', padding: '1rem', borderBottom: '1px solid #333', textAlign: 'center' }}>
                      <div style={{ textAlign: 'left' }}><span style={{ fontWeight: 'bold' }}>{idx + 1}.</span> {team}</div>
                      <div style={{ fontWeight: 'bold' }}>0</div>
                      <div style={{ fontWeight: 'bold' }}>0</div>
                      <div style={{ fontWeight: 'bold' }}>0</div>
                      <div style={{ fontWeight: 'bold' }}>0-0</div>
                      <div style={{ fontWeight: '900', color: '#BFFF00' }}>0</div>
                    </div>
                  ))}
                </div>
              </div>
